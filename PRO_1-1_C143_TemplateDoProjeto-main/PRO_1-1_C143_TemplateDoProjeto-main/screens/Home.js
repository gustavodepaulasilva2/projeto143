...
export default class HomeScreen extends Component {
  ...
  likedArticle = () => {
    const url = this.state.ngrok_url + "/likedArticle";
    axios
      .get(url)
      .then((response) => {
        this.setState({
          likedArticle: response.data.data,
        });
      })
      .catch((error) => {
        Alert.alert(error.message);
  ...
  unlikedArticle = () => {
      const url = this.state.ngrok_url + "/unlikedArticle";
      axios
        .get(url)
        .then((response) => {
          this.setState({
            unlikedArticle: response.data.data,
          });
        })
        .catch((error) => {
          Alert.alert(error.message);
